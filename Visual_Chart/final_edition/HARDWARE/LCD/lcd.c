...
extern const u8 gImage_E501[];
extern const u8 gImage_E491[];
extern const u8 gImage_E481[];
extern const u8 gImage_E471[];
extern const u8 gImage_E461[];
extern const u8 gImage_E451[];
extern const u8 gImage_E441[];
extern const u8 gImage_E431[];
extern const u8 gImage_E421[];
extern const u8 gImage_E411[];
extern const u8 gImage_E401[];
...
{  							  
  u8 temp,t1,t;
	...
	for(t=0;t<csize;t++)
	{   
		if(size==64)temp=asc2_6432[num][t];
...
//??????(???:????,???? or ????,???? ?????!)	   
//xsta,ysta,width,height:????
//scan:?image2lcd V2.9???.
//*p:????
void Image_show(u16 xsta,u16 ysta,u16 width,u16 height,int scan,u8 *p)
{  
	u32 i;
	u32 len=0;
	if(scan==0)
...
void Image_display(u16 x,u16 y,u8 * imgx,int i)
{
	HEADCOLOR *imginfo;
 	u8 ifosize=sizeof(HEADCOLOR);//??HEADCOLOR??????
	imginfo=(HEADCOLOR*)imgx;
	switch(i)
		{
			case 0:Image_show(x,y,imginfo->w,imginfo->h,i,imgx+ifosize);break;
			case 1:Image_show(x,y,imginfo->w,imginfo->h,i,imgx+ifosize);break;
		  case 2:Image_show(y,x,imginfo->w,imginfo->h,i,imgx+ifosize);break;
			case 3:Image_show(y,x,imginfo->w,imginfo->h,i,imgx+ifosize);break;
		}			
}

void Display_E(int size,int dict)
{
  switch(size)
	{
	  case 1:  Image_display(120,300,(u8*)gImage_E511,dict);break;			 
		case 2:	 Image_display(120,300,(u8*)gImage_E501,dict);break;		
  	case 3:  Image_display(120,300,(u8*)gImage_E491,dict);break;		
	  case 4:  Image_display(120,300,(u8*)gImage_E481,dict);break;
		case 5:	 Image_display(120,300,(u8*)gImage_E471,dict);break;	
		case 6:  Image_display(120,300,(u8*)gImage_E461,dict);break;
		case 7:	 Image_display(120,300,(u8*)gImage_E451,dict);break;	
		case 8:  Image_display(120,300,(u8*)gImage_E441,dict);break;
		case 9:  Image_display(120,300,(u8*)gImage_E431,dict);break;
		case 10: Image_display(120,300,(u8*)gImage_E421,dict);break;		
		case 11: Image_display(120,300,(u8*)gImage_E411,dict);break;		
		case 12: Image_display(120,300,(u8*)gImage_E401,dict);break;	
	}
}

void Display_RES(int size)
{
 switch(size)
 {
    case 1:  LCD_ShowString(200,350,300,32,32,"5.1");break;			 
		case 2:	 LCD_ShowString(200,350,300,32,32,"5.0");break;			
  	case 3:  LCD_ShowString(200,350,300,32,32,"4.9");break;			
	  case 4:  LCD_ShowString(200,350,300,32,32,"4.8");break;	
		case 5:	 LCD_ShowString(200,350,300,32,32,"4.7");break;	
		case 6:  LCD_ShowString(200,350,300,32,32,"4.6");break;	
		case 7:	 LCD_ShowString(200,350,300,32,32,"4.5");break;	
		case 8:  LCD_ShowString(200,350,300,32,32,"4.4");break;	
		case 9:  LCD_ShowString(200,350,300,32,32,"4,3");break;	
		case 10: LCD_ShowString(200,350,300,32,32,"4.2");break;		
		case 11: LCD_ShowString(200,350,300,32,32,"4.1");break;		
		case 12: LCD_ShowString(200,350,300,32,32,"4.0");break;	
 }
}
